...
export default function IntakeForm({
  ...
  const homeownersData: HomeownersData = {
    ...
    property_address_unit: submission.property_address_unit || '',
    ...
    property_place_id: submission.property_place_id ?? null,
    property_formatted: submission.property_formatted ?? null,
    property_addr_verified: Boolean(submission.property_addr_verified),
    ...
    last_roof_update: submission.last_roof_update || '',
