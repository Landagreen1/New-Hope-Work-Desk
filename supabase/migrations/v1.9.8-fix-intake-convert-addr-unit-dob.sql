-- v1.9.8 - Fix cs_intake_convert to include addr_unit and format DOB as M/D/YYYY
--
-- Issues fixed:
--   1. addr_unit (apt/suite) was not being passed in v_details on conversion
--   2. insured_dob and driver DOB were stored as ISO (YYYY-MM-DD) — now formatted M/D/YYYY
--      so agents see the expected US date format in their work item view
